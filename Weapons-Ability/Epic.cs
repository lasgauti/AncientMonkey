...
{ 
    ...
    public class Epic
    {
        ...
        public class AlluringMelody : WeaponTemplate
        {
            public override int SandboxIndex => 3;
            public override Rarity WeaponRarity => Rarity.Epic;
            public override string WeaponName => "Alluring Melody";
            public override string Icon => VanillaSprites.Mermonkey003;
            public override bool IsCamo => true;
            public override void EditTower(TowerModel towerModel)
            {
                var wpn = Game.instance.model.GetTowerFromId("Mermonkey-003").GetAttackModel(1).Duplicate();
                wpn.range = towerModel.range;
                towerModel.AddBehavior(wpn);
                AncientMonkey.mod.newAttackModels.Add(wpn);
            }
        ...
        public class FireCracker : WeaponTemplate
        {
            ...
            public override void EditTower(TowerModel towerModel)
            {
                ...
                wpn.weapons[0].projectile.GetDamageModel().immuneBloonProperties = Il2Cpp.BloonProperties.None;
                wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnExpireModel("Fragment", fragment, new ArcEmissionModel("FragmentEmmision_", 6, 0, 360, null, true, false), false, false));
        ...
        public class AciGunner : WeaponTemplate
        {
            ...
            public override void EditTower(TowerModel towerModel)
            {
                ...
                var slowModel = new SlowModel("SlowModel_", slow.multiplier, slow.lifespan, "AcidSlow", 3, overlay, slow.isUnique, slow.dontRefreshDuration, slow.effectModel, true, false, false, 100);
        ...
        public class Dreadnought : WeaponTemplate
        {
            ...
            public override void EditTower(TowerModel towerModel)
            {
                ...
                bleed.GetDescendant<DamageOverTimeModel>().damage += 1;
                bleed.GetDescendant<DamageOverTimeModel>().interval -= 1f;
        ...
        public class CarpetBomb : WeaponTemplate
        {
            ...
            public override void EditTower(TowerModel towerModel)
            {
                ...
                bomb.AddBehavior(new CreateProjectileOnExpireModel("ExpireExplosion", explosion, new ArcEmissionModel("", 1, 0, 0, null, true, false), false, false));
        ...
        public class SpectralClaws : WeaponTemplate
        {
            ...
            public override void EditTower(TowerModel towerModel)
            {
                ...
                wpn.weapons[0].projectile.AddBehavior(new CreateProjectileOnExpireModel("SpectralShards", shard, new ArcEmissionModel("", 3, 0, 30, null, false, false), false, false));
                wpn.range = towerModel.range;
                towerModel.AddBehavior(wpn);
                AncientMonkey.mod.newAttackModels.Add(wpn);
